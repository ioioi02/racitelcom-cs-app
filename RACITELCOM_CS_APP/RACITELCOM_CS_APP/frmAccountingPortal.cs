...
{
    public partial class frmAccountingPortal : Form
    {
        ...
        public frmAccountingPortal()
        {
            InitializeComponent();
        }

        private void frmAccountingPortal_Load(object sender, EventArgs e)
        {
        ...
        private void btnPayments_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtAccountNum.Text))
            {
                frmPaymentForm paymentForm = new frmPaymentForm(this);
                string accountNumString = txtAccountNum.Text.TrimStart('#');
                int account_num = Convert.ToInt32(accountNumString);
                account_num -= 10000;
                paymentForm.account_num = account_num;
        ...
        private void frmAccountingPortal_FormClosing(object sender, FormClosingEventArgs e)
        {
