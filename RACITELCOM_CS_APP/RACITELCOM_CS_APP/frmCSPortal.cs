...
{
    public partial class frmCSPortal : Form
    {
        ...
        private void frmCSPortal_Load(object sender, EventArgs e)
        {
            ...
            displayDatabase(default_query, null);
        ...
        private void frmCSPortal_FormClosing(object sender, FormClosingEventArgs e)
        {
