...
{
    public partial class frmPendingTicket : Form
    {
        ...
        private void Client_On_MessageReceived(string message)
        {
            if (InvokeRequired)
            {
                Invoke(new Action(() => {
                    ...
                    {
                        frmPendingTicket_Load(null, null);
                    }
                }));
            }
            else
        ...
        public void frmPendingTicket_Load(object sender, EventArgs e)
        {
